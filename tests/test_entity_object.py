...
class TestEntityObject(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.graph.add((EX.alice, EX.name, Literal("Alice")))
    ...
    def test_snippet(self):
        triples = list(self.entity.snippet.triples((URIRef(EX.alice), None, None)))
        self.assertGreaterEqual(len(triples), 2)
        self.assertIn((EX.alice, RDF.type, EX.Person), self.entity.snippet)
